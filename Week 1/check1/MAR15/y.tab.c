...
{
       0,    29,    29,    30,    33,    34,    34,    38,    53,    62,
      75,    79,    86,    87,    88,    89,    90,    91,    92
};
#endif
...
{
  "$end", "error", "$undefined", "ID", "INTNUM", "FLOATNUM", "OP", "END",
  "TYPE", "'+'", "'-'", "'*'", "'/'", "'\\n'", "'='", "','", "'('", "')'",
  "$accept", "program", "statement", "$@1", "dlist", "expr", YY_NULLPTR
};
#endif
...
{
      -8,     0,    -8,    -7,    -8,    -8,    -8,    -3,    -4,    16,
      27,     8,    12,    -8,    -3,    -3,    -3,    -3,     5,    28,
      29,    -8,    -1,    -8,    22,    22,    -8,    -8,    -8,    -8,
      -8,    -8,    34,    -8
};
...
{
       3,     0,     1,     0,    12,    13,     5,     0,     0,     4,
       0,     0,     0,     2,     0,     0,     0,     0,     0,     0,
       0,    11,     0,    18,    14,    15,    16,    17,     7,     9,
       8,     6,     0,    10
};
...
{
       2,     4,     5,     3,     4,     5,    31,    10,     6,    13,
      12,    21,    28,     7,    32,     0,     7,    24,    25,    26,
      27,    14,    15,    16,    17,    14,    15,    16,    17,    23,
      18,    19,    20,    16,    17,    29,    30,    33
};

static const yytype_int8 yycheck[] =
{
       0,     4,     5,     3,     4,     5,     7,    14,     8,    13,
       7,     3,     7,    16,    15,    -1,    16,    14,    15,    16,
      17,     9,    10,    11,    12,     9,    10,    11,    12,    17,
       3,     4,     5,    11,    12,     7,     7,     3
};
...
{
       0,    19,     0,     3,     4,     5,     8,    16,    20,    23,
      14,    21,    23,    13,     9,    10,    11,    12,     3,     4,
       5,     3,    22,    17,    23,    23,    23,    23,     7,     7,
       7,     7,    15,     3
};
...
#line 34 "yacc.y" /* yacc.c:1646  */
    {
		curtype = (char*) malloc(sizeof((yyvsp[0].type)));
                strcpy(curtype, (yyvsp[0].type));
	}
...
#line 38 "yacc.y" /* yacc.c:1646  */
    {
		if(lookup((yyvsp[-3].idname)) == NULL) {
			printf("%s Undeclared\n", (yyvsp[-3].idname));
		} else if(lookup((yyvsp[-1].idname)) == NULL) {
			printf("%s Undeclared\n", (yyvsp[-1].idname));
		} else if(strcmp(lookup((yyvsp[-3].idname)), lookup((yyvsp[-1].idname))) != 0) {
			if(strcmp(lookup((yyvsp[-3].idname)), "char") == 0)      {
                                printf("Error: Cannot cast int(%s) to char\n", (yyvsp[-1].idname));
                        } else if(strcmp(lookup((yyvsp[-3].idname)), "int") == 0)	{
...
#line 53 "yacc.y" /* yacc.c:1646  */
    {
		if(lookup((yyvsp[-3].idname)) == NULL) {
                        ...
                        if(strcmp(lookup((yyvsp[-3].idname)), "int") == 0)      {
...
#line 62 "yacc.y" /* yacc.c:1646  */
    {
                if(lookup((yyvsp[-3].idname)) == NULL) {
                        ...
                        if(strcmp(lookup((yyvsp[-3].idname)), "float") == 0)      {
