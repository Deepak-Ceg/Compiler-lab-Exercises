...
static yyconst flex_int16_t yy_accept[20] =
    {   0,
        1,    1,    1,    2,    3,    5,    7,    9,   10,   13,
       16,   17,   18,   19,   20,   22,   23,   25,   25
    } ;
...
static yyconst flex_uint16_t yy_base[21] =
    {   0,
        0,    0,   22,   23,    4,   23,    8,    0,   12,   16,
       15,   23,   17,    0,    0,    0,   14,   23,    6,    4
    } ;

static yyconst flex_int16_t yy_def[21] =
    {   0,
       18,    1,   18,   18,   18,   18,   18,    5,   18,   18,
        9,   18,    7,   19,    9,   20,   20,    0,   18,   18
    } ;

static yyconst flex_uint16_t yy_nxt[29] =
    {   0,
        4,    5,    4,    6,    7,    8,   16,   14,    9,   10,
       11,   12,   13,   14,   11,   17,   15,   10,   17,   11,
       16,   18,    3,   18,   18,   18,   18,   18
    } ;

static yyconst flex_int16_t yy_chk[29] =
    {   0,
        1,    1,    1,    1,    1,    5,   20,   19,    5,    7,
        7,    7,    7,    9,    9,   17,    9,   10,   13,   11,
       10,    3,   18,   18,   18,   18,   18,   18
    } ;
